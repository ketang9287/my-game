...
BULLET_HIT = pygame.mixer.Sound('assets/Gun+Silencer.mp3')
BULLET_FIRE = pygame.mixer.Sound('assets/Grenade+1.mp3')
BACKGROUND_MUSIC = pygame.mixer.Sound('assets/StarWars.mp3')
SHIP_WIDTH = 40
SHIP_HEIGHT = 55
SHIP_VEL = 4
BULLET_VEL = 10
